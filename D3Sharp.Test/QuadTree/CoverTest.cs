    ...
    public class CoverTest
    {
        ...
        public void TrivialExtentIfNull()
        {
            Tests.AreValuesEqual(new double[,] { { 1, 2 }, { 2, 3 } },
                new QuadTree<QuadTreeData>().Cover(1, 2).Extents);
        }
        ...
        public void NonTrivialSquarifiedNCenteredExtentIfTrivial()
        {
            Tests.AreValuesEqual(new double[,] { { 0, 0 }, { 4, 4 } },
                new QuadTree<QuadTreeData>().Cover(0, 0).Cover(1, 2).Extents);
        }
        ...
        public void IgnoreInvalidPoints()
        {
            Tests.AreValuesEqual(new double[,] { { 0, 0 }, { 1, 1 } },
                new QuadTree<QuadTreeData>().Cover(0, 0).Cover(double.NaN, 2).Extents);
        }
        ...
        public void RepeatWrapRootIfChildren()
        {
            var datas = new List<QuadTreeData> {
                ...
                new QuadTreeData{X=2,Y=2},
            };
            var q = new QuadTree<QuadTreeData>(datas);
        ...
        {
            var data = new QuadTreeData { X = 2, Y = 2 };
            var q = new QuadTree<QuadTreeData>().Cover(0, 0).Add(data);
        ...
        {
            var q = new QuadTree<QuadTreeData>().Cover(0, 0).Cover(2, 2);
